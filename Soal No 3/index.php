...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm fixed-top">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1">Combox Bertingkat</span>
        </div>
    </nav>
    <div class="container-fluid">
        <div class=" row justify-content-md-center">
            ...
            <div class="col-md-6 pt-5">
                ...
                <div class="card" style="width: 100%;">
                    <div class="card-body">
                        <h5 class="card-title text-center">Combobox Bertingkat Wilayah Indonesia</h5>
                        <h6 class="card-subtitle mb-2 text-muted text-center">Liza Umma Nur Hidayah | PTI20B</h6>
                        <form>
